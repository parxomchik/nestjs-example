...
import {
  Body, Controller, HttpCode, Get, Post, Delete,
  Put, Param, Request, UnauthorizedException,
  UseGuards, HttpStatus, NotFoundException,
  ForbiddenException, UseInterceptors,
} from '@nestjs/common';
import {
  ApiTags, ApiBody, ApiOkResponse, ApiBearerAuth,
  ApiInternalServerErrorResponse, ApiUnauthorizedResponse,
...
export default class AuthController {
  ...
  @Post('sign-in')
  async signIn(@Request() req: ExpressRequest): Promise<SuccessResponse> {
